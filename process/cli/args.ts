...
export function printUsage(): string {
  return [
    ...
    "  --layout=<путь>    TOML-схема, каталог с TOML или несколько --layout (по умолчанию: layouts/)",
    "  --out=<каталог>    корень выхода (по умолчанию: build; подкаталог ОС добавляется автоматически)",
